                ...
                if antiSpam is True:
                  ...
                  if retry:
                      ...
                      if data["punishment"] == "kick":
                        ...
                        hacker = discord.Embed(color=discord.Color.default(),description=f"<a:green_tick:1103363669263405157> | Successfully Muted {message.author} For Spamming")
                      ...
                      if data["punishment"] == "ban":
                        now = discord.utils.utcnow()
                        await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Dilbar Support | Anti Spam")
                        hacker1 = discord.Embed(color=discord.Color.default(),description=f"<a:green_tick:1103363669263405157> | Successfully Muted {message.author} For Spamming")
                      ...
                      if data["punishment"] == "none":
                        now = discord.utils.utcnow()
                        await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Dilbar Support | Anti Spam")
                        hacker2 = discord.Embed(color=discord.Color.default(),description=f"<a:green_tick:1103363669263405157> | Successfully Muted {message.author} For Spamming")
                ...
                if antiLink is True:
                    ...
                    if invite_matches:
                        ...
                        if data["punishment"] == "kick":
                            ...
                            hacker3 = discord.Embed(color=discord.Color.default(),description=f"<a:green_tick:1103363669263405157> | Successfully Muted {message.author} For Sending Discord Server Invites")
                        ...
                        if data["punishment"] == "ban":
                            await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Dilbar Support | Anti Discord Invites")
                            hacker4 = discord.Embed(color=discord.Color.default(),description=f"<a:green_tick:1103363669263405157> | Successfully Muted {message.author} For Sending Discord Server Invites")
                        ...
                        if data["punishment"] == "none":
                             now = discord.utils.utcnow()
                             await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Dilbar Support | Anti Discord Invites")
                             hacker5 = discord.Embed(color=discord.Color.default(),description=f"<a:green_tick:1103363669263405157> | Successfully Muted {message.author} For Sending Discord Server Invites")
                    ...
                    if link_matches:
                        if data["punishment"] == "kick":
                          ...
                          hacker6 = discord.Embed(color=discord.Color.default(),description=f"<a:green_tick:1103363669263405157> | Successfully Muted {message.author} For Sending Links")
                        ...
                        if data["punishment"] == "ban":
                          await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Dilbar Support | Anti Link")
                          hacker7 = discord.Embed(color=discord.Color.default(),description=f"<a:green_tick:1103363669263405157> | Successfully Muted {message.author} For Sending Links")
                        ...
                        if data["punishment"] == "none":
                          now = discord.utils.utcnow()
                          await message.author.timeout(now + datetime.timedelta(minutes=15), reason="Dilbar Support | Anti Link")
                          hacker8 = discord.Embed(color=discord.Color.default(),description=f"<a:green_tick:1103363669263405157> | Successfully Muted {message.author} For Sending Links")
