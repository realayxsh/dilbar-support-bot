...
class Fun(commands.Cog):
    ...
    @commands.hybrid_command(usage="hug <member>")
    @blacklist_check()
    @ignore_check()
    ...
    @commands.hybrid_command(name="pet", usage="Pet <member>")
    @blacklist_check()
    @ignore_check()
    ...
    @commands.hybrid_command(name="penis",
                      aliases=['dick'],
    ...
    @commands.hybrid_command(name="meme", help="give you a meme", usage="meme")
    @blacklist_check()
    @ignore_check()
    async def meme(self, ctx):
        embed = discord.Embed(title="""Take some memes""", color=discord.Color.default())
        async with aiohttp.ClientSession() as cs:
            async with cs.get(
    ...
    async def cat(self, ctx):
        embed = discord.Embed(title="""Here's a cat""", color=discord.Color.default())
        async with aiohttp.ClientSession() as cs:
