...
class afk(commands.Cog):
    ...
    async def on_message(self, message):
      try:
        ...
        if message.mentions:
            for user_mention in message.mentions:
                if afk[f'{user_mention.id}']['AFK'] == 'True':
                    ...
                    wl = discord.Embed(description=f'**{str(user_mention)}** went AFK <t:{ok}:R> : {reason}', color=discord.Color.default())
                ...
                if afk[f'{message.author.id}']['AFK'] == 'True':
                    ...
                    wlba = discord.Embed(description=f'Welcome Back {str(message.author.mention)}, You got **{mentionz}** Mentions while You were AFK, I removed your AFK. You were afk for **{been_afk_for}**', color=discord.Color.default())
                    ...
                    if afk[f'{user_mention.id}']['AFK'] == 'True':
                        ...
                        reason = afk[f'{user_mention.id}']['reason']
                        ok = afk[f'{user_mention.id}']['time']
                        wlt = discord.Embed(description=f'**{str(user_mention)}** went AFK <t:{ok}:R> : {reason}', color=discord.Color.default())
        ...
        if afk[f'{message.author.id}']['AFK'] == 'True':
            ...
            afk[f'{message.author.id}']['guild'].remove(message.guild.id)
            afk[f'{message.author.id}']['reason'] == None
            wlbat = discord.Embed(description=f'Welcome Back {str(message.author.mention)}, You got **{mentionz}** Mentions while You were AFK, I removed your AFK. You were afk for **{been_afk_for}**', color=discord.Color.default())
    ...
    async def afk(self, ctx, *, reason=None):
        ...
        if 'discord.gg' in reason:
            emd = discord.Embed(description=f"You can't Advertise in Afk Reason", color=discord.Color.default())
        ...
        if '.gg/' in reason:
            eme = discord.Embed(description=f"You can't Advertise in Afk Reason", color=discord.Color.default())
            return await ctx.send(embed=eme)

        view = OnOrOff(ctx)
        

        em = discord.Embed(description="**Shall the bot DM you on every mention while you're afk?**", color=discord.Color.default())
        try:
        ...
        await test.delete()
        af = discord.Embed(description=f'{ctx.author.mention} Your AFK is now set to: {reason}', color=discord.Color.default())
