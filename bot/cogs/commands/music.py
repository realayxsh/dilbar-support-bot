...
class DisPlayer(Player):
    ...
    async def invoke_player(self, ctx: commands.Context = None) -> None:
        ...
        embed = discord.Embed(title=track.title, url=track.uri, color=discord.Color.default())
...
class Music(commands.Cog):
    ...
    @commands.hybrid_command(name="play", usage="play <search>", aliases=[("p")])
    @blacklist_check()
    @ignore_check()
    ...
    @commands.hybrid_command(name="volume", usage="volume <vol>", aliases=[("vol")])
    @commands.guild_only()
    @blacklist_check()
    @ignore_check()
    ...
    @commands.hybrid_command(name="nowplaying", usage="nowplaying", aliases=[("now")])
    @blacklist_check()
    @ignore_check()
    ...
    @commands.hybrid_command(name="shuffle", usage="shuffle", aliases=[("shuff")])
    @blacklist_check()
    @ignore_check()
    ...
    @commands.hybrid_command(name="pull", usage="pull <index>")
    @blacklist_check()
    @ignore_check()
    ...
    async def _queue(self, ctx):
        ...
        hacker4 = discord.Embed(title="Music | Queue", color=discord.Color.default())
    ...
    @commands.hybrid_command(name="seek", aliases=["sk"], usage="seek")
    @blacklist_check()
    @ignore_check()
