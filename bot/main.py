  ...
  if context.guild is not None:
    try:
      ...
      embed.add_field(
        ...
        inline=False)
      embed.set_footer(text="Powered By Dilbar Support",
    ...
    try:
      ...
      embed1 = discord.Embed(color=discord.Color.default())
      embed1.set_author(
        name=f"Executed {executed_command} Command By : {context.author}",
        icon_url=f"{context.author.avatar}")
      ...
      embed1.add_field(
        ...
        f"{context.author} | ID: [{context.author.id}](https://discord.com/users/{context.author.id})",
        inline=False)
      embed1.set_footer(text="Powered By Dilbar Support",
                        icon_url=client.user.display_avatar.url)
...
async def makeembed(ctx, *, description):
  ...
  embed = discord.Embed(description=description, color=discord.Color.default())
